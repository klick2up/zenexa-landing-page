...
@section('title', 'Create Template - Klick2Up Admin')
...
<div class="mb-8">
    ...
    <p class="text-sm text-gray-500 mt-1 ml-8">Design a new reusable email template for your campaigns.</p>
</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., Welcome Email" class="w-full rounded-xl border border-gray-200 focus:border-accent focus:ring focus:ring-accent/20 transition-all p-3 text-sm outline-none bg-gray-50/50" required>
                    </div>

                    <div class="space-y-2">
                        <label for="subject" class="block text-sm font-semibold text-gray-700">Email Subject Line <span class="text-red-500">*</span></label>
                        <input type="text" id="subject" name="subject" value="{{ old('subject') }}" placeholder="Welcome to Klick2Up!" class="w-full rounded-xl border border-gray-200 focus:border-accent focus:ring focus:ring-accent/20 transition-all p-3 text-sm outline-none bg-gray-50/50" required>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="rounded-xl border border-gray-200 overflow-hidden">
                            <textarea id="body_html" name="body_html" class="hidden">{{ old('body_html') }}</textarea>
                        </div>
